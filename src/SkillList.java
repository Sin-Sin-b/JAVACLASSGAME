...
Skill cut(){return new Skill("베기","대상을 벤다","일반스킬",20,1);}
...
Skill crush() {return new Skill("분쇄","적에게 강한 일격을 날린다.","일반스킬",45,4);}

Skill ruinousWave() {return new Skill("파멸의 검기", "전방으로 파괴적인 어둠 검기를 날린다", "마검스킬", 60, 5);}
